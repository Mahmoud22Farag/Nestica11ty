  ...
  cart.forEach((item, index) => {
    ...
    div.innerHTML = `
      <div class="d-flex gap-3 align-items-center">
        <img src="${item.image || '/assets/images/products/default-product.jpeg'}" class="cart-item-img" onerror="this.onerror=null;this.src='{{ '/assets/images/products/default-product.jpeg' | url }}';">
